...
//      Checks for errors in form data for add product
        if(bindingResult.hasErrors()) {
			...
			System.out.println(String.format("Bad Add Product call with %s, %s, %s, %s", productModel.getName(), productModel.getType(),
            ...
            System.out.println(String.format("Good Add Product call with %s, %s, %s, %s", productModel.getName(), productModel.getType(),
            		productModel.getPrice(), productModel.getDescription()));
        }
...
//      Checks for errors in form data for update product
        if(bindingResult.hasErrors()) {
            System.out.println(bindingResult);
            System.out.println(String.format("Bad Update Product call with %s, %s, %s, %s", productModel.getName(), productModel.getType(),
        			productModel.getPrice(), productModel.getDescription()));
            ...
            // Prints user model data to console           
        	System.out.println(String.format("Good Update Product call with %s, %s, %s, %s", productModel.getName(), productModel.getType(),
        			productModel.getPrice(), productModel.getDescription()));
        }
